...
31 flows in the account. Focus flows (winback/abandon/post-purchase/checkout/replenish/sunset) include full trigger detail.

| Flow | Status | Trigger type | Created | Updated |
|---|---|---|---|---|
| PCOS Post-Purchase Flow | live | Metric | 2026-02-27 | 2026-07-02 |
...
| Abandoned Checkout Touch 2/3 Companion — 2026 design system | draft | Metric | 2026-07-02 | 2026-07-02 |
...
| Abandoned Checkout Consultant Check — 2026 design system | live | Metric | 2026-07-02 | 2026-07-02 |
...
| Abandoned Checkout Consultant Check — 2026 design system | live | Metric | 2026-06-11 | 2026-07-02 |
...
```
trigger: {"type": "metric", "id": "WZAxyj", "trigger_filter": {"condition_groups": [{"conditions": [{"type": "metric-property", "metric_id": "WZAxyj", "field": "Items", "filter": {"type": "list", "operator": "contains", "value": "DELFRAN - Pcositol - 30 Sachets"}}, {"type": "metric-property", "metric_id": "WZAxyj", "field": "Items", "filter": {"type": "list", "operator": "contains", "value": "DELFRAN - Pcositol Orange & Lime - 30 Sachets"}}]}]}}
...
### Abandoned Checkout Touch 2/3 Companion — 2026 design system (`SN89LS`, draft)
...
### Abandoned Checkout Touch 2/3 Companion — 2026 design system (`SkRBCP`, draft)

```
trigger: {"type": "metric", "id": "WnzuVG", "trigger_filter": null}
  entry_action_id: 110841854
...
### Abandoned Checkout Consultant Check — 2026 design system (`TR9tVa`, live)
...
### Abandoned Checkout Touch 2/3 Companion — 2026 design system (`YcByas`, live)

```
trigger: {"type": "metric", "id": "WnzuVG", "trigger_filter": null}
  entry_action_id: 110841649
  profile_filter: {"condition_groups": [{"conditions": [{"type": "profile-metric", "metric_id": "WZAxyj", "measurement": "count", "measurement_filter": {"type": "numeric", "operator": "equals", "value": 0}, "timeframe_filter": {"type": "date", "operator": "flow-start"}, "metric_filters": null}]}, {"conditions": [{"type": "profile-not-in-flow", "timeframe_filter": {"type": "date", "operator": "in-the-last", "unit": "day", "quantity": 7}}]}]}
```
